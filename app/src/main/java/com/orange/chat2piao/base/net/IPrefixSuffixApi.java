...
public interface IPrefixSuffixApi {
     ...
     * @param <T>            网络返回实体
     */
    <T> void get(String prefix, String suffix, Map<String, String> params, INetCallback<T> callback, INoDataCallback noDataCallback);
     ...
     * @param <T>            网络返回实体
     */
    <T> void get(Map<String, String> headers, String prefix, String suffix, Map<String, String> params, INetCallback<T> callback, INoDataCallback noDataCallback);
     ...
     * @param <T>            网络返回实体
     */
    <T> void post(String prefix, String suffix, Map<String, String> params, INetCallback<T> callback, INoDataCallback<T> noDataCallback);
     ...
     * @param <T>            网络返回实体
     */
    <T> void post(Map<String, String> headers, String prefix, String suffix, Map<String, String> params, INetCallback<T> callback, INoDataCallback noDataCallback);
}
