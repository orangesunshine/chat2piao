...
public class RetrofitPrefixSuffixApi implements IPrefixSuffixApi {
     ...
     */
    @Override
    public <T> void get(String prefix, String suffix, Map<String, String> params, INetCallback<T> callback, INoDataCallback noDataCallback) {
     ...
     */
    @Override
    public <T> void get(Map<String, String> headers, String prefix, String suffix, Map<String, String> params, INetCallback<T> callback, INoDataCallback noDataCallback) {
     ...
     */
    @Override
    public <T> void post(String prefix, String suffix, Map<String, String> params, INetCallback<T> callback, INoDataCallback<T> noDataCallback) {
     ...
     */
    @Override
    public <T> void post(Map<String, String> headers, String prefix, String suffix, Map<String, String> params, INetCallback<T> callback, INoDataCallback noDataCallback) {
