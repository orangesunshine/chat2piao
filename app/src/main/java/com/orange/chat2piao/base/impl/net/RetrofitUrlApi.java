...
import com.orange.chat2piao.base.ifc.net.IUrlApi;
...
public class RetrofitUrlApi implements IUrlApi {
     ...
     */
    @Override
    public <T> void get(String url, Map<String, String> params, IPullNetCallback<T> callback, INoDataCallback noDataCallback) {
     ...
     */
    @Override
    public <T> void get(Map<String, String> headers, String url, Map<String, String> params, IPullNetCallback<T> callback, INoDataCallback noDataCallback) {
     ...
     */
    @Override
    public <T> void post(String url, Map<String, String> params, IPullNetCallback<T> callback, INoDataCallback noDataCallback) {
     ...
     */
    @Override
    public <T> void post(Map<String, String> headers, String url, Map<String, String> params, IPullNetCallback<T> callback, INoDataCallback noDataCallback) {
