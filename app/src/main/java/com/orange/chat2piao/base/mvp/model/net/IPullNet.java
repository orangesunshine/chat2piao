...
public interface IPullNet {
    ...
    <DATA, ITEM> void concactPullNet(@IPullNetRequest.PullType int type, RecyclerView rv, View emptyLayout, final CommonAdapter<ITEM> adapter, IRefreshNdLoadmore refreshNdLoadmore, IPullNetRequest<DATA> request, IPullNetResultCallback<DATA, ITEM> resultCallback);
