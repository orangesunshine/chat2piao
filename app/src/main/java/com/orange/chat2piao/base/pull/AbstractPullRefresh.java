...
public abstract class AbstractPullRefresh<REFRESH extends View, F extends View> implements IPull, IPullCallback {
    ...
    public <T> AbstractPullRefresh(IHolder holder, IPageNetRequest<T> pageRequest) {
